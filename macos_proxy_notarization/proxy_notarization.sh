...
echo "====================Downloading wf proxy 7.0 RC from s3===================="
mkdir temp_new_WF_proxy
WF_PROXY="`wget https://packagecloud.io/wavefront/proxy-next/packages/ubuntu/bionic/wavefront-proxy_7.0-RC1-1_amd64.deb/download.deb`"
$WF_PROXY
brew install dpkg
...
cp temp_new_WF_proxy/opt/wavefront/wavefront-proxy/bin/wavefront-proxy.jar lib/proxy-uber.jar;
