...
public class LineBasedBlockFilter implements AnnotatedPredicate<String> {
  ...
  public LineBasedBlockFilter(
      final String patternMatch, final PreprocessorRuleMetrics ruleMetrics) {
    this.compiledPattern =
        Pattern.compile(Preconditions.checkNotNull(patternMatch, "[match] can't be null"));
