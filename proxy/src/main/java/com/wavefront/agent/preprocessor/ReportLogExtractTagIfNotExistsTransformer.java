 ...
 * If such log tag already exists, the value won't be overwritten.
 *
 * @author amitw@vmware.com
 */
public class ReportLogExtractTagIfNotExistsTransformer extends ReportLogExtractTagTransformer {

  public ReportLogExtractTagIfNotExistsTransformer(final String tag,
                                                   final String input,
    ...
    super(tag, input, patternSearch, patternReplace, replaceInput, patternMatch, v2Predicate, ruleMetrics);
  }
