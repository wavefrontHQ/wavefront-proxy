...
public class SpanExtractAnnotationTransformer implements Function<Span, Span> {
  ...
  protected boolean extractAnnotation(
      @Nonnull Span span, final String extractFrom, List<Annotation> annotationBuffer) {
