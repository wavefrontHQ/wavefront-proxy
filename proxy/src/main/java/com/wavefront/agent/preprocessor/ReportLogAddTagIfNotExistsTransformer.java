...
/**
 * Creates a new log tag with a specified value. If such log tag already exists, the value won't be overwritten.
 *
...
public class ReportLogAddTagIfNotExistsTransformer extends ReportLogAddTagTransformer {
  ...
  public ReportLogAddTagIfNotExistsTransformer(final String tag,
                                               final String value,
