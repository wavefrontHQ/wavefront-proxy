    ...
    switch (source) {
      ...
      default:
        if (reportPoint.getAnnotations() != null
            && reportPoint.getAnnotations().get(source) != null) {
          if (extractTag(reportPoint, reportPoint.getAnnotations().get(source))
            ...
            reportPoint
                ...
                .put(
                    source,
                    compiledSearchPattern
                        .matcher(reportPoint.getAnnotations().get(source))
                        .replaceAll(expandPlaceholders(patternReplaceSource, reportPoint)));
          }
        }
    }
