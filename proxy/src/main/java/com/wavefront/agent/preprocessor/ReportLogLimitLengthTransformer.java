...
public class ReportLogLimitLengthTransformer implements Function<ReportLog, ReportLog> {
  ...
  public ReportLogLimitLengthTransformer(@Nonnull final String scope,
                                         final int maxLength,
  ...
  public ReportLog apply(@Nullable ReportLog reportLog) {
    ...
    try {
      ...
      switch (scope) {
        case "message":
          if (reportLog.getMessage().length() > maxLength && (compiledMatchPattern == null ||
          ...
          break;
        case "sourceName":
          if (reportLog.getHost().length() > maxLength && (compiledMatchPattern == null ||
