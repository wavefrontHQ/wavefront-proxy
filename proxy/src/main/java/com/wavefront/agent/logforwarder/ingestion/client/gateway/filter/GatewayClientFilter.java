...
/**
 * An interface to filter the requests coming into GatewayClient
 * and customize the response.
 */
public interface GatewayClientFilter {

    Optional<GatewayResponse> applyFilter(GatewayRequest request);
}
