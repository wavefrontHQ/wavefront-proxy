...
public class ChannelStringHandler extends SimpleChannelInboundHandler<String> {
    ...
    public ChannelStringHandler(Decoder decoder, final ForceQueueEnabledAgentAPI agentAPI,
        final UUID daemonId, final int port, final String prefix, final String logLevel,
        final String validationLevel, final long millisecondsPerBatch,
        final int blockedPointsPerBatch, @Nullable final Function<String, String> transformer,
        ...
        this.pointLineWhiteList = StringUtils.isBlank(pointLineWhiteListRegex) ?
            null :
            Pattern.compile(pointLineWhiteListRegex);

        this.pointLineBlackList = StringUtils.isBlank(pointLineBlackListRegex) ?
            null :
            Pattern.compile(pointLineBlackListRegex);
