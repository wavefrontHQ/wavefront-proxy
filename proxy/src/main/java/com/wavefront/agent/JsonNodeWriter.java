...
public class JsonNodeWriter implements MessageBodyWriter<JsonNode> {
  ...
  @Override
  public long getSize(JsonNode jsonNode, Class<?> type, Type genericType, Annotation[]
      annotations, MediaType mediaType) {
    return -1;
  }

  @Override
  public void writeTo(JsonNode jsonNode, Class<?> type, Type genericType, Annotation[]
