...
class HttpGetTokenIntrospectionAuthenticator extends TokenIntrospectionAuthenticator {
  ...
  HttpGetTokenIntrospectionAuthenticator(
      @Nonnull HttpClient httpClient,
      @Nonnull String tokenIntrospectionServiceUrl,
    ...
    this(
        ...
        tokenIntrospectionServiceAuthorizationHeader,
  ...
  HttpGetTokenIntrospectionAuthenticator(
    ...
    Preconditions.checkNotNull(
        tokenIntrospectionServiceUrl, "tokenIntrospectionServiceUrl parameter must be set");
    this.httpClient = httpClient;
    this.tokenIntrospectionServiceUrl = tokenIntrospectionServiceUrl;
    this.tokenIntrospectionServiceAuthorizationHeader =
        tokenIntrospectionServiceAuthorizationHeader;
  }
