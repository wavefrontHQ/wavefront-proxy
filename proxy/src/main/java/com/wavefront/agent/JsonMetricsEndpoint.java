...
public class JsonMetricsEndpoint extends PointHandler {
    ...
    public JsonMetricsEndpoint(final QueuedAgentService agentApi, final UUID daemonId,
        final int port, final String host, @Nullable final String prefix, final String logLevel,
        final String validationLevel, final long millisecondsPerBatch,
    ...
    public Response reportMetrics(@QueryParam("h") String host, @QueryParam("p") String prefix,
        @QueryParam("d") Long timestamp, @Context UriInfo uriInfo, JsonNode metrics) {
