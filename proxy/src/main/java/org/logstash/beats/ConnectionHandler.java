...
public class ConnectionHandler extends ChannelDuplexHandler {
   ...
   * {@inheritDoc} <br>
   *
   * <p><strong>IdleState.WRITER_IDLE <br>
   * </strong> If no response has been issued after the configured write idle timeout via {@link
   ...
   * not timeout and retry which could result in duplicates. <br>
   *
   * <p><strong>IdleState.ALL_IDLE <br>
   * </strong> If no read or write has been issued after the configured all idle timeout via {@link
   ...
   *
   * <ul>
   *   <li>This Handler comes before the {@link BeatsHandler} in the channel's pipeline
   *   <li>This Handler is associated to an {@link io.netty.channel.EventLoopGroup} that has
   *       guarantees that the associated {@link io.netty.channel.EventLoop} will never block.
   *   <li>The {@link BeatsHandler} un-sets only after it has processed this channel's payload.
   * </ul>
   *
