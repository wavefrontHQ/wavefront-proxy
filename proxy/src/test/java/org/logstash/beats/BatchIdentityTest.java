...
public class BatchIdentityTest {
  ...
  public void testEquals() {
    ...
    assertNotEquals(
        ...
        new BatchIdentity("2019-09-17T01:02:03.123Z", 1, 5, "test.log", 123));
    assertNotEquals(
        new BatchIdentity("2019-09-17T01:02:03.123Z", 1, 5, null, null),
        new BatchIdentity("2019-09-17T01:02:03.123Z", 1, 5, null, 123));
  }
  ...
  public void testCreateFromMessage() {
    Message message =
        new Message(
            ...
            ImmutableMap.builder()
                .put(
                    "@metadata",
                    ImmutableMap.of("beat", "filebeat", "type", "_doc", "version", "7.3.1"))
                ...
                .put(
                    ...
                    ImmutableMap.of(
                        ...
                        "host1.acme.corp",
                        "id",
                        "6DF46E56-37A3-54F8-9541-74EC4DE13483"))
                .put(
                    "log",
                    ImmutableMap.of("offset", 6599, "file", ImmutableMap.of("path", "test.log")))
                .put(
                    "agent",
                    ImmutableMap.of(
                        "id",
                        "30ff3498-ae71-41e3-bbcb-4a39352da0fe",
                        "version",
                        "7.3.1",
                        "type",
                        "filebeat",
                        ...
                        "host1.acme.corp",
                        "ephemeral_id",
                        "fcb2e75f-859f-4706-9f14-a16dc1965ff1"))
                .build());
    Message message2 =
        new Message(
            102,
            ImmutableMap.builder()
                ...
                .put(
                    "log",
                    ImmutableMap.of("offset", 6799, "file", ImmutableMap.of("path", "test.log")))
                .put(
                    "agent",
                    ImmutableMap.of(
                        "id",
    ...
    assertEquals(new BatchIdentity("2019-09-17T01:02:03.123Z", 102, 2, "test.log", 6599), identity);
  }
}
