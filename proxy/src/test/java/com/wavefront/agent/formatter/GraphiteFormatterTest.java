...
public class GraphiteFormatterTest {
  ...
  public void testCollectdGraphiteParsing() {
    String format = "4,3,2"; // Extract the 4th, 3rd, and 2nd segments of the metric as the
    ...
    Assert.assertTrue(nsPerOps < 10 * 1000); // make sure it was less than 10 μs per run; it's
    // around 1 μs on my machine
  }
}
