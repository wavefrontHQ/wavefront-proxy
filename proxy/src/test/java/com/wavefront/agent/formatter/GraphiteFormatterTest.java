...
public class GraphiteFormatterTest {
    ...
    public void testCollectdGraphiteParsing() {
        String format =
            "4,3,2"; // Extract the 4th, 3rd, and 2nd segments of the metric as the hostname, in that order
        String delimiter = "_";
        ...
        Assert.assertTrue(
            formatter.getOps() >= 1000 * 1000);  // make sure we actually ran it 1M times
        Assert.assertTrue(nsPerOps < 10
