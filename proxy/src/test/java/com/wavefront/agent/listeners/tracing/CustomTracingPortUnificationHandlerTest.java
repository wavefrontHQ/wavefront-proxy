...
public class CustomTracingPortUnificationHandlerTest {
    ...
    public void reportsCorrectDuration() {
        ...
        CustomTracingPortUnificationHandler subject = new CustomTracingPortUnificationHandler(
                null,
                null,
                null,
                null,
    ...
    private Span getSpan() {
        Span span = new Span();
        span.setAnnotations(ImmutableList.of(
                new Annotation("application", "application"),
                new Annotation("service", "service")
        ));
        return span;
    }
