...
public class OtlpTestHelpers {
  ...
  public static ReportableEntityPreprocessor blockSpanPreprocessor() {
    ...
    preprocessor
        .forSpan()
        .addFilter(
            new SpanBlockFilter("sourceName", "test-source", x -> true, preprocessorRuleMetrics));
  ...
  public static ExportTraceServiceRequest otlpTraceRequest(
    ...
    InstrumentationLibrarySpans ilSpans =
        InstrumentationLibrarySpans.newBuilder().addSpans(otlpSpan).build();
    ResourceSpans rSpans =
        ResourceSpans.newBuilder().addInstrumentationLibrarySpans(ilSpans).build();
    ExportTraceServiceRequest request =
        ExportTraceServiceRequest.newBuilder().addResourceSpans(rSpans).build();
    return request;
  }
}
