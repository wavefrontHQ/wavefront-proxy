...
import com.wavefront.api.agent.preprocessor.SpanReplaceRegexTransformer;
...
public class JaegerGrpcCollectorHandlerTest {
  ...
  public void testJaegerGrpcCollector() throws Exception {
    ...
    Model.KeyValue customApplicationTag =
        Model.KeyValue.newBuilder()
            .setKey("application")
    ...
    Model.Batch testBatch =
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder().setServiceName("frontend").addTags(ipTag).build())
  ...
  public void testApplicationTagPriority() throws Exception {
    ...
    Model.KeyValue spanLevelAppTag =
        Model.KeyValue.newBuilder()
            .setKey("application")
    ...
    Model.KeyValue processLevelAppTag =
        Model.KeyValue.newBuilder()
            .setKey("application")
    ...
    Model.Batch testBatchForProxyLevel =
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder().setServiceName("frontend").addTags(ipTag).build())
  ...
  public void testJaegerDebugOverride() throws Exception {
    ...
    Model.KeyValue samplePriorityTag =
        Model.KeyValue.newBuilder()
  ...
  public void testSourceTagPriority() throws Exception {
    ...
    Model.KeyValue hostNameProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("hostname")
    ...
    Model.KeyValue customSourceProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("source")
    ...
    Model.KeyValue customSourceSpanTag =
        Model.KeyValue.newBuilder()
            .setKey("source")
        ...
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder()
                    .setServiceName("frontend")
                    .addTags(ipTag)
                    .addTags(hostNameProcessTag)
                    .addTags(customSourceProcessTag)
                    .build())
            .addAllSpans(ImmutableList.of(span1, span2))
            .build();
  ...
  public void testIgnoresServiceTags() throws Exception {
    ...
    Model.KeyValue sourceProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("source")
            .setVStr("source-processtag")
            .setVType(Model.ValueType.STRING)
    ...
    Model.KeyValue customServiceProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("service")
    ...
    Model.KeyValue customServiceSpanTag =
        Model.KeyValue.newBuilder()
            .setKey("service")
        ...
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder()
                    .setServiceName("frontend")
                    .addTags(ipTag)
                    .addTags(sourceProcessTag)
                    .addTags(customServiceProcessTag)
                    .build())
            .addAllSpans(ImmutableList.of(span1, span2))
            .build();
  ...
  public void testProtectedTagsSpanOverridesProcess() throws Exception {
    ...
    Model.KeyValue customApplicationProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("application")
    ...
    Model.KeyValue customApplicationSpanTag =
        Model.KeyValue.newBuilder()
            .setKey("application")
    ...
    Model.KeyValue customClusterProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("cluster")
    ...
    Model.KeyValue customClusterSpanTag =
        Model.KeyValue.newBuilder()
            .setKey("cluster")
    ...
    Model.KeyValue customShardProcessTag =
        Model.KeyValue.newBuilder()
            .setKey("shard")
    ...
    Model.KeyValue customShardSpanTag =
        Model.KeyValue.newBuilder()
            .setKey("shard")
  ...
  public void testAllProcessTagsPropagated() throws Exception {
    ...
    Model.KeyValue customProcessTag1 =
        Model.KeyValue.newBuilder()
            .setKey("processTag1")
            .setVStr("one")
            .setVType(Model.ValueType.STRING)
    ...
    Model.KeyValue customProcessTag2 =
        Model.KeyValue.newBuilder()
            .setKey("processTag2")
            .setVStr("two")
            .setVType(Model.ValueType.STRING)
    ...
    Model.KeyValue customProcessTag3 =
        Model.KeyValue.newBuilder()
            .setKey("processTag3")
            .setVStr("three")
            .setVType(Model.ValueType.STRING)
        ...
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder()
                    ...
                    .addTags(ipTag)
                    .addTags(hostNameProcessTag)
                    .addTags(customProcessTag1)
                    .addTags(customProcessTag2)
                    .addTags(customProcessTag3)
                    .build())
            .addAllSpans(ImmutableList.of(span))
            .build();
   ...
   * values post applying preprocessing rules to the span.
   */
  @Test
  public void testJaegerPreprocessedDerivedMetrics() throws Exception {
          ...
          preprocessor
              ...
              .addTransformer(
                  new SpanReplaceRegexTransformer(
                      CLUSTER_TAG_KEY,
                      "^none.*",
                      PREPROCESSED_CLUSTER_TAG_VALUE,
                      null,
                      null,
                      false,
                      x -> true,
    ...
    Model.Batch testBatch =
        Model.Batch.newBuilder()
            .setProcess(
                Model.Process.newBuilder().setServiceName("testService").addTags(ipTag).build())
