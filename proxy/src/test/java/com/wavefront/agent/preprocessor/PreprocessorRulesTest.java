...
public class PreprocessorRulesTest {
  ...
  public void testPointInRangeCorrectForTimeRanges() {
    ...
    AnnotatedPredicate<ReportPoint> pointInRange1year =
        new ReportPointTimestampInRangeFilter(8760, 24, () -> time);
    // not in range if over a year ago
    ReportPoint rp =
        new ReportPoint("some metric", time - millisPerYear, 10L, "host", "table", new HashMap<>());
    ...
    AnnotatedPredicate<ReportPoint> pointInRange1day =
        new ReportPointTimestampInRangeFilter(24, 24, () -> time);
    ...
    AnnotatedPredicate<ReportPoint> pointInRange12hours =
        new ReportPointTimestampInRangeFilter(12, 12, () -> time);
    ...
    AnnotatedPredicate<ReportPoint> pointInRange10Days =
        new ReportPointTimestampInRangeFilter(240, 240, () -> time);
  ...
  public void testLineReplaceRegexNullMatchThrows() {
    ...
    LineBasedReplaceRegexTransformer invalidRule =
        new LineBasedReplaceRegexTransformer(null, FOO, null, null, metrics);
  }
  ...
  public void testLineReplaceRegexBlankMatchThrows() {
    ...
    LineBasedReplaceRegexTransformer invalidRule =
        new LineBasedReplaceRegexTransformer("", FOO, null, null, metrics);
  }
  ...
  public void testPointBlockNullMatchThrows() {
    ...
    ReportPointBlockFilter invalidRule = new ReportPointBlockFilter(FOO, null, null, metrics);
  }
  ...
  public void testReportPointFiltersWithValidV2AndInvalidV1Predicate() {
    try {
      ReportPointAllowFilter invalidRule =
          new ReportPointAllowFilter("metricName", null, x -> false, metrics);
    ...
    try {
      ReportPointAllowFilter invalidRule =
          new ReportPointAllowFilter(null, "^host$", x -> false, metrics);
    } catch (IllegalArgumentException e) {
      // Expected.
    }
    ...
    try {
      ReportPointAllowFilter invalidRule =
          new ReportPointAllowFilter("metricName", "^host$", x -> false, metrics);
    } catch (IllegalArgumentException e) {
      // Expected.
    }

    try {
      ReportPointBlockFilter invalidRule =
          new ReportPointBlockFilter("metricName", null, x -> false, metrics);
    } catch (IllegalArgumentException e) {
      // Expected.
    }
    ...
    try {
      ReportPointBlockFilter invalidRule =
          new ReportPointBlockFilter(null, "^host$", x -> false, metrics);
    } catch (IllegalArgumentException e) {
      // Expected.
    }
    ...
    try {
      ReportPointBlockFilter invalidRule =
          new ReportPointBlockFilter("metricName", "^host$", x -> false, metrics);
    } catch (IllegalArgumentException e) {
      // Expected.
    }
  }
  ...
  public void testReportPointFiltersWithValidV2AndV1Predicate() {
    ReportPointAllowFilter validAllowRule =
        new ReportPointAllowFilter(null, null, x -> false, metrics);

    ReportPointBlockFilter validBlocktRule =
        new ReportPointBlockFilter(null, null, x -> false, metrics);
  }
  ...
  public void testPointLineRules() {
    ...
    String testPoint2 =
        "collectd.#cpu#.&loadavg^.1m 7 1459527231 source=source$hostname foo=bar boo=baz";
    String testPoint3 =
        "collectd.cpu.loadavg.1m;foo=bar;boo=baz;tag=extra 7 1459527231 source=hostname";

    LineBasedReplaceRegexTransformer rule1 =
        new LineBasedReplaceRegexTransformer("(boo)=baz", "$1=qux", null, null, metrics);
    LineBasedReplaceRegexTransformer rule2 =
        new LineBasedReplaceRegexTransformer("[#&\\$\\^]", "", null, null, metrics);
    ...
    LineBasedReplaceRegexTransformer rule5 =
        new LineBasedReplaceRegexTransformer("cpu", "gpu", ".*hostname.*", null, metrics);
    LineBasedReplaceRegexTransformer rule6 =
        new LineBasedReplaceRegexTransformer("cpu", "gpu", ".*nomatch.*", null, metrics);
    LineBasedReplaceRegexTransformer rule7 =
        new LineBasedReplaceRegexTransformer(
            "([^;]*);([^; ]*)([ ;].*)", "$1$3 $2", null, 2, metrics);

    String expectedPoint1 = "collectd.cpu.loadavg.1m 7 1459527231 source=hostname foo=bar boo=qux";
    String expectedPoint2 =
        "collectd.cpu.loadavg.1m 7 1459527231 source=sourcehostname foo=bar boo=baz";
    String expectedPoint5 = "collectd.gpu.loadavg.1m 7 1459527231 source=hostname foo=bar boo=baz";
    String expectedPoint7 =
        "collectd.cpu.loadavg.1m;tag=extra 7 1459527231 source=hostname foo=bar boo=baz";
  ...
  public void testReportPointRules() {
    String pointLine =
        "\"Some Metric\" 10.0 1469751813 source=\"Host\" \"boo\"=\"Baz\" \"foo\"=\"bar\"";
    ...
    String expectedPoint4 =
        "\"some metric\" 10.0 1469751813 source=\"host\" \"boo\"=\"baz\" \"qux\"=\"bar\"";
    ...
    String expectedPoint5 =
        "\"some metric\" 10.0 1469751813 source=\"host\" \"foo\"=\"baz\" \"qux\"=\"bar\"";
    ...
    String expectedPoint6 =
        "\"prefix.some metric\" 10.0 1469751813 source=\"host\" \"foo\"=\"baz\" \"qux\"=\"bar\"";
    assertEquals(expectedPoint6, referencePointToStringImpl(point));

    // replace regex in metric name, no matches - shouldn't change
    new ReportPointReplaceRegexTransformer(METRIC_NAME, "Z", "", null, null, null, metrics)
        .apply(point);
    assertEquals(expectedPoint6, referencePointToStringImpl(point));

    // replace regex in metric name - shouldn't affect anything else
    new ReportPointReplaceRegexTransformer(METRIC_NAME, "o", "0", null, null, null, metrics)
        .apply(point);
    String expectedPoint7 =
        "\"prefix.s0me metric\" 10.0 1469751813 source=\"host\" \"foo\"=\"baz\" \"qux\"=\"bar\"";
    assertEquals(expectedPoint7, referencePointToStringImpl(point));

    // replace regex in source name - shouldn't affect anything else
    new ReportPointReplaceRegexTransformer(SOURCE_NAME, "o", "0", null, null, null, metrics)
        .apply(point);
    String expectedPoint8 =
        "\"prefix.s0me metric\" 10.0 1469751813 source=\"h0st\" \"foo\"=\"baz\" \"qux\"=\"bar\"";
    ...
    String expectedPoint9 =
        "\"prefix.s0me metric\" 10.0 1469751813 source=\"h0st\" \"foo\"=\"zaz\" \"qux\"=\"bar\"";
    assertEquals(expectedPoint9, referencePointToStringImpl(point));

    // replace regex in a point tag value with matching groups
    new ReportPointReplaceRegexTransformer("qux", "([a-c][a-c]).", "$1z", null, null, null, metrics)
        .apply(point);
    String expectedPoint10 =
        "\"prefix.s0me metric\" 10.0 1469751813 source=\"h0st\" \"foo\"=\"zaz\" \"qux\"=\"baz\"";
    ...
    new ReportPointReplaceRegexTransformer(
            "qux",
            "az",
            "{{foo}}-{{no_match}}-g{{sourceName}}-{{metricName}}-{{}}",
            null,
            null,
            null,
            metrics)
  ...
  public void testAgentPreprocessorForReportPoint() {
    ...
    String expectedPoint5 =
        "\"metric\" 7.0 1459527231 source=\"src\" "
    ...
    String expectedPoint6 =
        "\"some.metric\" 7.0 1459527231 source=\"hostname\" "
    ...
    String expectedPoint7 =
        "\"node0.node1.testExtractTag.node4\" 7.0 1459527231 source=\"host0-host1\" "
  ...
  public void testMetricsFilters() {
    for (int port : new int[] {9999, 9997}) {
      assertTrue(
          "error on port=" + port,
          applyAllFilters(
              "tururu.poi.dff.ok 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));
      assertTrue(
          "error on port=" + port,
          applyAllFilters("metrics.2.ko 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));

      assertTrue(
          "error on port=" + port,
          applyAllFilters("metrics.1 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));
      assertFalse(
          "error on port=" + port,
          applyAllFilters("metrics.1.ko 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));

      assertFalse(
          "error on port=" + port,
          applyAllFilters(
              "tururu.poi.dff.ko 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));
      assertFalse(
          "error on port=" + port,
          applyAllFilters("metrics.ok.2 7 1459527231 source=h.prod.corp foo=bar boo=baz", port));
    }
  ...
  public void testReportPointLimitRuleDropMetricNameThrows() {
    new ReportPointLimitLengthTransformer(
        METRIC_NAME, 10, LengthLimitActionType.DROP, null, null, metrics);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testReportPointLimitRuleDropSourceNameThrows() {
    new ReportPointLimitLengthTransformer(
        SOURCE_NAME, 10, LengthLimitActionType.DROP, null, null, metrics);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testReportPointLimitRuleTruncateWithEllipsisMaxLengthLessThan3Throws() {
    new ReportPointLimitLengthTransformer(
        "tagK", 2, LengthLimitActionType.TRUNCATE_WITH_ELLIPSIS, null, null, metrics);
  }

  @Test
  public void testReportPointLimitRule() {
    String pointLine =
        "metric.name.1234567 1 1459527231 source=source.name.test foo=bar bar=bar1234567890";
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            METRIC_NAME, 6, LengthLimitActionType.TRUNCATE, null, null, metrics);
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            METRIC_NAME, 6, LengthLimitActionType.TRUNCATE, "nope.*", null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            SOURCE_NAME, 11, LengthLimitActionType.TRUNCATE, null, null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            SOURCE_NAME, 11, LengthLimitActionType.TRUNCATE, "nope.*", null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            "bar", 10, LengthLimitActionType.TRUNCATE, null, null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            "bar", 10, LengthLimitActionType.TRUNCATE, ".*456.*", null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    assertEquals(10, point.getAnnotations().get("bar").length());
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            "bar", 10, LengthLimitActionType.TRUNCATE, ".*nope.*", null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            "bar", 10, LengthLimitActionType.TRUNCATE_WITH_ELLIPSIS, null, null, metrics);
    point = rule.apply(parsePointLine(pointLine));
    assertEquals(10, point.getAnnotations().get("bar").length());
    ...
    rule =
        new ReportPointLimitLengthTransformer(
            "bar", 10, LengthLimitActionType.DROP, ".*456.*", null, metrics);
    point = rule.apply(parsePointLine(pointLine));
  ...
  public void testPreprocessorUtil() {
    assertEquals(
        "input...",
        PreprocessorUtil.truncate("inputInput", 8, LengthLimitActionType.TRUNCATE_WITH_ELLIPSIS));
    assertEquals(
        "inputI", PreprocessorUtil.truncate("inputInput", 6, LengthLimitActionType.TRUNCATE));
    try {
  ...
  public void testExtractTagPointLineRule() {
    ...
    ReportPoint metricNameMatchPoint = parsePointLine(metricNameMatchString);
    ...
    ReportPoint existingTagMatchPoint =
        parsePointLine(originalPointStringWithTag + "\"newExtractTag\"=\"originalValue\"");
    new ReportPointExtractTagTransformer(
            "newExtractTag",
            "pointLine",
            ".*extractTag.*",
  ...
  public void testExtractTagIfNotExistsPointLineRule() {
    ...
    String originalPointStringWithTag =
        "\"extractTagMetric\" 1.0 1459527231 source=\"testHost\" " + "\"aKey\"=\"aValue\"";
    ...
    new ReportPointExtractTagIfNotExistsTransformer(
        ...
        .apply(existingTagMatchPoint);
    assertEquals(
        originalPointStringWithTag + addedTag, referencePointToStringImpl(existingTagMatchPoint));

    // Point tag already exists, keep existing value.
    String originalTagExistsString =
        "\"extractTagMetric\" 1.0 1459527231 source=\"testHost\" "
