...
public class PreprocessorRuleV2PredicateTest {
  private static final String[] COMPARISON_OPS = {
    "equals", "startsWith", "contains", "endsWith", "regexMatch"
  };
  ...
  public void testReportPointPreprocessorComparisonOps() {
    ...
    for (String comparisonOp : COMPARISON_OPS) {
      List<Map<String, Object>> rules =
          (List<Map<String, Object>>) rulesByPort.get(comparisonOp + "-reportpoint");
      ...
      switch (comparisonOp) {
        case "equals":
          point =
              new ReportPoint(
                  "foometric.1", System.currentTimeMillis(), 10L, "host", "table", null);
          Assert.assertTrue(
              "Expected [equals-reportpoint] rule to return :: true , Actual :: " + "false",
              v2Predicate.test(point));
          break;
        case "startsWith":
          point =
              new ReportPoint(
                  "foometric.2", System.currentTimeMillis(), 10L, "host", "table", null);
          Assert.assertTrue(
              "Expected [startsWith-reportpoint] rule to return :: true , " + "Actual :: false",
              v2Predicate.test(point));
          break;
        case "endsWith":
          point =
              new ReportPoint(
                  "foometric.3", System.currentTimeMillis(), 10L, "host-prod", "table", pointTags);
          Assert.assertTrue(
              "Expected [endsWith-reportpoint] rule to return :: true , Actual :: " + "false",
              v2Predicate.test(point));
          break;
        case "regexMatch":
          point =
              new ReportPoint(
                  "foometric.4", System.currentTimeMillis(), 10L, "host", "table", null);
          Assert.assertTrue(
              "Expected [regexMatch-reportpoint] rule to return :: true , Actual ::" + " false",
              v2Predicate.test(point));
          break;
        case "contains":
          point =
              new ReportPoint(
                  ...
                  pointTags);
          Assert.assertTrue(
              "Expected [contains-reportpoint] rule to return :: true , Actual :: " + "false",
              v2Predicate.test(point));
          break;
      }
    }
  ...
  public void testReportPointPreprocessorComparisonOpsList() {
    ...
    for (String comparisonOp : COMPARISON_OPS) {
      List<Map<String, Object>> rules =
          (List<Map<String, Object>>) rulesByPort.get(comparisonOp + "-list-reportpoint");
      Assert.assertEquals("Expected rule size :: ", 1, rules.size());
      Map<String, Object> v2PredicateMap = (Map<String, Object>) rules.get(0).get("if");
      Predicate<ReportPoint> v2Predicate = Predicates.parsePredicate(v2PredicateMap);
      Map<String, String> pointTags = new HashMap<>();
  ...
  public void testSpanPreprocessorComparisonOpsList() {
    ...
    for (String comparisonOp : COMPARISON_OPS) {
      List<Map<String, Object>> rules =
          (List<Map<String, Object>>) rulesByPort.get(comparisonOp + "-list-span");
      Assert.assertEquals("Expected rule size :: ", 1, rules.size());
      Map<String, Object> v2PredicateMap = (Map<String, Object>) rules.get(0).get("if");
      ...
      switch (comparisonOp) {
        case "equals":
          ...
          Assert.assertTrue(
              "Expected [equals-span] rule to return :: true , Actual :: " + "false",
          ...
          span =
              parseSpan(
                  "testSpanName.2 "
                      ...
                      + "traceId=d5355bf7-fc8d-48d1-b761-75b170f396e0 1532012145123 1532012146234");
          Assert.assertTrue(
              "Expected [startsWith-span] rule to return :: true , " + "Actual :: false",
              v2Predicate.test(span));
          break;
        case "endsWith":
          span =
              parseSpan(
                  "testSpanName.1 "
                      ...
                      + "traceId=d5355bf7-fc8d-48d1-b761-75b170f396e0 1532012145123 1532012146234");
          Assert.assertTrue(
              "Expected [endsWith-span] rule to return :: true , Actual :: " + "false",
              v2Predicate.test(span));
          break;
        case "regexMatch":
          span =
              parseSpan(
                  "testSpanName.1 "
                      ...
                      + "traceId=d5355bf7-fc8d-48d1-b761-75b170f396e0 1532012145123 1532012146234");
          Assert.assertTrue(
              "Expected [regexMatch-span] rule to return :: true , Actual ::" + " false",
              v2Predicate.test(span));
          break;
        case "contains":
          span =
              parseSpan(
                  "testSpanName.1 "
                      ...
                      + "traceId=d5355bf7-fc8d-48d1-b761-75b170f396e0 1532012145123 1532012146234");
          Assert.assertTrue(
              "Expected [contains-span] rule to return :: true , Actual :: " + "false",
              v2Predicate.test(span));
          break;
      }
    }
  ...
  public void testSpanPreprocessorComparisonOps() {
    ...
    for (String comparisonOp : COMPARISON_OPS) {
      List<Map<String, Object>> rules =
          (List<Map<String, Object>>) rulesByPort.get(comparisonOp + "-span");
      Assert.assertEquals("Expected rule size :: ", 1, rules.size());
      Map<String, Object> v2PredicateMap = (Map<String, Object>) rules.get(0).get("if");
      Predicate<Span> v2Predicate = Predicates.parsePredicate(v2PredicateMap);
      Map<String, String> pointTags = new HashMap<>();
  ...
  public void testPreprocessorReportPointLogicalOps() {
    ...
    point =
        new ReportPoint("foometric.1", System.currentTimeMillis(), 10L, "host", "table", pointTags);
    Assert.assertTrue(
        "Expected [logicalop-reportpoint] rule to return :: true , Actual :: false",
        v2Predicate.test(point));
    ...
    point =
        new ReportPoint("foometric.1", System.currentTimeMillis(), 10L, "host", "table", pointTags);
    Assert.assertFalse(
        "Expected [logicalop-reportpoint] rule to return :: false , Actual :: " + "true",
        v2Predicate.test(point));
    ...
    pointTags.put("key2", "val2");
    point =
        new ReportPoint("boometric.1", System.currentTimeMillis(), 10L, "host", "table", pointTags);
    Assert.assertFalse(
        "Expected [logicalop-reportpoint] rule to return :: false , Actual :: " + "true",
        v2Predicate.test(point));
