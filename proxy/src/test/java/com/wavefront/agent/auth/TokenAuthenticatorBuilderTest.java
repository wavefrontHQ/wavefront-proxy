...
public class TokenAuthenticatorBuilderTest {
  ...
  public void testBuilderOutput() {
    ...
    assertTrue(
        TokenAuthenticatorBuilder.create()
                .setTokenValidationMethod(TokenValidationMethod.NONE)
                .build()
            instanceof DummyAuthenticator);

    assertTrue(
        TokenAuthenticatorBuilder.create()
                .setTokenValidationMethod(TokenValidationMethod.STATIC_TOKEN)
                .setStaticToken("statictoken")
                .build()
            instanceof StaticTokenAuthenticator);
    ...
    assertTrue(
        TokenAuthenticatorBuilder.create()
                ...
                .build()
            instanceof HttpGetTokenIntrospectionAuthenticator);
    ...
    assertTrue(
        TokenAuthenticatorBuilder.create()
                .setTokenValidationMethod(TokenValidationMethod.OAUTH2)
                .setHttpClient(httpClient)
                .setTokenIntrospectionServiceUrl("https://acme.corp/url")
                .build()
            instanceof Oauth2TokenIntrospectionAuthenticator);
  ...
  public void testBuilderHttpGetIncompleteArguments2Throws() {
    TokenAuthenticatorBuilder.create()
        .setTokenValidationMethod(TokenValidationMethod.HTTP_GET)
        .setTokenIntrospectionServiceUrl("http://acme.corp")
        .build();
  }
