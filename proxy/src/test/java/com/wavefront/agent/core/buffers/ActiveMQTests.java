...
public class ActiveMQTests {
  ...
  public void expired() throws Throwable {
    ...
    AddressSettings addressSetting = new AddressSettings().setMaxExpiryDelay(10L);
    amq.getActiveMQServer().getAddressSettingsRepository().addMatch(TEST_QUEUE, addressSetting);
    ...
    Thread.sleep(1000);
    CompositeData[] msgs = queueControl.browse("expiration < " + System.currentTimeMillis());
    Thread.sleep(1000);
